...
builder.addCardString('D002E480          024 K 26 002 * 13     JUMP IF DOUBLE INDEX')
...
builder.addCardString('D007E404          024 H 25 004 A 48')
...
builder.addCardString('E---E007     E  7 020 E  6 010 *  0     \'GO\' BUT NO TASK')
...
builder.addCardString('E---E503          024,2410,561,2416')
...
builder.addCardString('E---E540     * 54 054,4450,501,2467     \'INDEX VALUE MUST BE BETWEEN INTEGER AND')
builder.addCardString('E---E541          007,0560,422,1464       0-INDEX-99.\'')
...
builder.addCardString('E---E733          010,4161,621,2451')
...
builder.addCardString('E---E766          101,4630,622,3045')
...
builder.addCardString('E---E785          007,0311,461,3451')
...
builder.addCardString('F000E050          020 P  4 071    0     COMPUTE 1/2 SFX')
...
builder.addCardString('F001E450     *  8 004 T  0 030 ----')
...
builder.addCardString('G001E150     *  5 020 $  0 002 * 13     POP Q3')
...
builder.addCardString('G001E900          020 Q  3 050 * 92     CHECK AND CONVERT SECOND INDEX')
...
builder.addCardString('G005E240          020 $  0 010 = 5      VALIDATE STEP NUMBER')
...
builder.addCardString('G006E610     * 13 020 P  1 124 K 10')
builder.addCardString('G006E620          025 K 19 002 * 20     JUMP IF TERMINAL')
builder.addCardString('G006E625          020 $  0 010 = 76     VERIFY PRECEDING SPACE')
...
builder.addCardString('X001E090          929 H 10 002 X 11     JUMP IF BUFFER AVAILABLE FOR MSG')
...
builder.addCardString('X003E600          014 = 25         ,')
...
builder.addCardString('X007E430          020 H 21 010 $  1')
...
builder.addCardString('=021E090          020 $  0 010 = 12')
...
builder.addCardString('=021E250          020 $  0 010 = 13     PUSH Q3')
...
builder.addCardString('=025E030          001 *  3 040 S  1     LOAD BUFFER IF ASSIGNED')
...
builder.addCardString('=027E080          020 P  2 052 *  2')
...
builder.addCardString('=032E370     * 11 020 T  1 001 * 11')
...
builder.addCardString('=054E100          050 H  8 010 $  0     SET START TIME OF CURRENT SHOT')
...
builder.addCardString('=079E000+    = 79 024 K  2 010 $  0     VERIFY PRECEDING')
